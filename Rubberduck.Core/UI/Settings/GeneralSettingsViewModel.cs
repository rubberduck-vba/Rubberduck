...
namespace Rubberduck.UI.Settings
{
    ...
    public sealed class GeneralSettingsViewModel : SettingsViewModelBase<Rubberduck.Settings.GeneralSettings>, ISettingsViewModel<Rubberduck.Settings.GeneralSettings>
    {
        ...
        {
            if (!_messageBox.ConfirmYesNo(GeneralSettingsPage.CompileBeforeParse_WarnCompileOnDemandEnabled,
                GeneralSettingsPage.CompileBeforeParse_WarnCompileOnDemandEnabled_Caption, true))
            {
                return false;
            }
