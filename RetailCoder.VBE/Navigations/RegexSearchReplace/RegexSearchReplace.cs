...
namespace Rubberduck.Navigations.RegexSearchReplace
{
    public class RegexSearchReplace : IRegexSearchReplace
    {
        ...
        private readonly RubberduckCodePaneFactory _codePaneFactory;

        public RegexSearchReplace(RegexSearchReplaceModel model, RubberduckCodePaneFactory codePaneFactory)
        {
            _model = model;
