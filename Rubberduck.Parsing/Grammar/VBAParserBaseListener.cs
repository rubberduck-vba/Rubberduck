...
public partial class VBAParserBaseListener : IVBAParserListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterModuleOption([NotNull] VBAParser.ModuleOptionContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="VBAParser.moduleOption"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitModuleOption([NotNull] VBAParser.ModuleOptionContext context) { }
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterExpression([NotNull] VBAParser.ExpressionContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="VBAParser.expression"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitExpression([NotNull] VBAParser.ExpressionContext context) { }
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterLExpression([NotNull] VBAParser.LExpressionContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="VBAParser.lExpression"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitLExpression([NotNull] VBAParser.LExpressionContext context) { }
