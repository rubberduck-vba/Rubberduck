...
namespace Rubberduck.Parsing.Binding
{
    public sealed class IndexDefaultBinding : IExpressionBinding
    {
        ...
        public IBoundExpression Resolve()
        {
            ...
            ResolveArgumentList(_lExpression.Classification != ExpressionClassification.ResolutionFailed
                ? _lExpression.ReferencedDeclaration
                : null);
        ...
        private IBoundExpression Resolve(IBoundExpression lExpression)
        {
            ...
            var boundExpression = ResolveLExpressionIsVariablePropertyFunctionNoParameters(lExpression);
        ...
        private IBoundExpression ResolveLExpressionIsVariablePropertyFunctionNoParameters(IBoundExpression lExpression)
        {
            ...
            var functionWithParameters = lExpression.Classification == ExpressionClassification.Function && !((IParameterizedDeclaration)lExpression.ReferencedDeclaration).Parameters.Any();
            if (lExpression.ReferencedDeclaration == null ||
                !isVariable && ((!propertyWithParameters && !functionWithParameters) || !_argumentList.HasArguments))
            {
                return null;
            }
            ...
            var boundExpression = ResolveDefaultMember(lExpression, asTypeName, asTypeDeclaration);
            if (boundExpression != null)
            {
                return boundExpression;
            }
        ...
        private IBoundExpression ResolveDefaultMember(IBoundExpression lExpression, string asTypeName, Declaration asTypeDeclaration)
        {
            ...
            */
            var hasDefaultMember = asTypeDeclaration != null
            ...
            var classModule = (ClassModuleDeclaration)asTypeDeclaration;
            var defaultMember = classModule.DefaultMember;
            var isPropertyGetLetFunctionProcedure =
