...
namespace Rubberduck.Parsing.Symbols
{
    public static class ParserRuleContextHelper
    {
        ...
        public static IList<CommonToken> GetTokens(ParserRuleContext context, CommonTokenStream tokenStream)
        {
            // Can be null if the input is empty it seems.
            if (context.Stop == null)
            {
                return new List<CommonToken>();
            }
            // Gets the tokens belonging to the context from the token stream. 
            //CommonToken is the default token type generated by Antlr. We need the cast because CommonTokens have settable properties.
            return (IList<CommonToken>)tokenStream.GetTokens(context.SourceInterval.a, context.SourceInterval.b);
        }
