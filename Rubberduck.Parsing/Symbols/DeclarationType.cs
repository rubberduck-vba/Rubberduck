...
namespace Rubberduck.Parsing.Symbols
{
    ...
    public enum DeclarationType : long
    {
        ...
        ResultVariable = 1L << 17 | Variable,
        Constant = 1L << 18,
        Enumeration = 1L << 19,
        EnumerationMember = 1L << 20,
        Event = 1L << 21,
        UserDefinedType = 1L << 22,
        UserDefinedTypeMember = 1L << 23,
        LibraryFunction = 1L << 24 | Function,
        LibraryProcedure = 1L << 25 | Procedure,
        LineLabel = 1L << 26,
        UnresolvedMember = 1L << 27,
        BracketedExpression = 1L << 28,
        ComAlias = 1L << 29,
        MdiForm = 1L << 30 | VbForm,
        ResFile = 1L << 31,
        PropPage = 1L << 32 | ClassModule,
        UserControl = 1L << 33 | ClassModule,
        DocObject = 1L << 34 | ClassModule,
        RelatedDocument = 1L << 35,
        ActiveXDesigner = 1L << 36 | ClassModule
    }
