...
{
    public sealed class VBATokenStreamPreprocessorVisitor : VBAConditionalCompilationParserBaseVisitor<IExpression>
    {
        private readonly SymbolTable<string, IValue> _symbolTable;
        private readonly ICharStream _stream;
        private readonly CommonTokenStream _tokenStream;

        public VBATokenStreamPreprocessorVisitor(
        ...
        {
            return new TokenStreamConditionalCompilationConstantExpression(
