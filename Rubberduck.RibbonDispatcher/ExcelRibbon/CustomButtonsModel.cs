...
namespace RubberDuck.RibbonDispatcher {
    ...
    internal class CustomButtonsModel {
        ...
        public CustomButtonsModel(RibbonFactory factory) {
            Group   = factory.NewRibbonCommon("CustomButtonsGroup",false);
            Group.SetText(factory.NewLanguageControlRibbonText("Custom Apps", null, null, null));

            Button1 = factory.NewRibbonButton("AppLaunchButton1");
            Button1.AsRibbonControl.SetText(factory.NewLanguageControlRibbonText("Button #1", null, null, null));
            Button1.Clicked += (s,e) => MessageBox.Show("Pressed Custom Button #1 pressed.", (s as IRibbonCommon)?.Id??"", MessageBoxButtons.OK);

            Button2 = factory.NewRibbonButton("AppLaunchButton2");
            Button2.AsRibbonControl.SetText(factory.NewLanguageControlRibbonText("Button #2", null, null, null));
            Button2.Clicked += (s,e) => MessageBox.Show("Custom Button #2 pressed.", (s as IRibbonCommon)?.Id??"", MessageBoxButtons.OK);
 
            Button3 = factory.NewRibbonButton("AppLaunchButton3");
            Button3.AsRibbonControl.SetText(factory.NewLanguageControlRibbonText("Button #3", null, null, null));
            Button3.Clicked += (s,e) => MessageBox.Show("Custom Button #3 pressed.", (s as IRibbonCommon)?.Id??"", MessageBoxButtons.OK);
 
            SizeToggle = factory.NewRibbonToggle("SizeToggle");
            SizeToggle.AsRibbonControl.SetText(factory.NewLanguageControlRibbonText("Show Small", "Toggles Button Size", 
