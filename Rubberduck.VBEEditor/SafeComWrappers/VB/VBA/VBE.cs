...
{
    public class VBE : SafeComWrapper<VBAIA.VBE>, IVBE
    {
        public VBE(VBAIA.VBE target)
            : base(target)
        {
        }
        ...
        public ICodePane ActiveCodePane
        {
            ...
            set { if (!IsWrappingNullReference) Target.ActiveCodePane = (VBAIA.CodePane)value.Target; }
        }

        public IVBProject ActiveVBProject
        {
            get => new VBProject(IsWrappingNullReference ? null : Target.ActiveVBProject);
            set { if (!IsWrappingNullReference) Target.ActiveVBProject = (VBAIA.VBProject)value.Target; }
        }
        ...
        public override bool Equals(ISafeComWrapper<VBAIA.VBE> other)
        {
        ...
        {
            return Equals(other as SafeComWrapper<VBAIA.VBE>);
        }
