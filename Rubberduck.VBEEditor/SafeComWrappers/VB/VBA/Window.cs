...
{
    public class Window : SafeComWrapper<VBAIA.Window>, IWindow
    {
        public Window(VBAIA.Window window)
            : base(window)
        {
        }
        ...
        public override bool Equals(ISafeComWrapper<VBAIA.Window> other)
        {
        ...
        {
            return Equals(other as SafeComWrapper<VBAIA.Window>);
        }
