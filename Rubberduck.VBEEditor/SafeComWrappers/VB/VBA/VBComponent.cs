...
{
    public class VBComponent : SafeComWrapper<VBAIA.VBComponent>, IVBComponent
    {
        public VBComponent(VBAIA.VBComponent target) : base(target) { }
        ...
        public IControls Controls
        {
            get
            {
                var designer = IsWrappingNullReference
                    ? null
                    : Target.Designer as VBAIA.Forms.UserForm;
        ...
        public override bool Equals(ISafeComWrapper<VBAIA.VBComponent> other)
        {
        ...
        {
            return Equals(other as SafeComWrapper<VBAIA.VBComponent>);
        }
