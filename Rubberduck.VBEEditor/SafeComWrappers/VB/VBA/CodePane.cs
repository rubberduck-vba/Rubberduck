...
{
    public class CodePane : SafeComWrapper<VBAIA.CodePane>, ICodePane
    {
        public CodePane(VBAIA.CodePane codePane)
            : base(codePane)
        {
        }
        ...
        public QualifiedSelection? GetQualifiedSelection()
        {
            ...
            var component = new VBComponent((VBAIA.VBComponent)CodeModule.Parent.Target);
        ...
        public override bool Equals(ISafeComWrapper<VBAIA.CodePane> other)
        {
        ...
        {
            return Equals(other as SafeComWrapper<VBAIA.CodePane>);
        }
