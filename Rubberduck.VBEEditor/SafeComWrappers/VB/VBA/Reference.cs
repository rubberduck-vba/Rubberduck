...
{
    public class Reference : SafeComWrapper<VBAIA.Reference>, IReference
    {
        public Reference(VBAIA.Reference target) 
            : base(target)
        {
        }
        ...
        public override bool Equals(ISafeComWrapper<VBAIA.Reference> other)
        {
        ...
        {
            return Equals(other as SafeComWrapper<VBAIA.Reference>);
        }
