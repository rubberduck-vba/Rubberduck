...
namespace Rubberduck.VBEditor.SafeComWrappers.VB.VBA
{
    ...
    public class CodeModule : SafeComWrapper<VBAIA.CodeModule>, ICodeModule
    {
        public CodeModule(VBAIA.CodeModule target) 
            : base(target)
        {
        }
        ...
        public override bool Equals(ISafeComWrapper<VBAIA.CodeModule> other)
        {
        ...
        {
            return Equals(other as SafeComWrapper<VBAIA.CodeModule>);
        }
