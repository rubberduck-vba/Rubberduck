...
{
    public class VBProject : SafeComWrapper<VBAIA.VBProject>, IVBProject
    {
        public VBProject(VBAIA.VBProject vbProject)
            :base(vbProject)
        {
        }
        ...
        public override bool Equals(ISafeComWrapper<VBAIA.VBProject> other)
        {
        ...
        {
            return Equals(other as SafeComWrapper<VBAIA.VBProject>);
        }
