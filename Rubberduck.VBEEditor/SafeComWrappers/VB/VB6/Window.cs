...
{
    public class Window : SafeComWrapper<VB6IA.Window>, IWindow
    {
        public Window(VB6IA.Window window)
            : base(window)
        {
        }
        ...
        {
            Target.SetKind((VB6IA.vbext_WindowType)eKind);
        }
        ...
        public override bool Equals(ISafeComWrapper<VB6IA.Window> other)
        {
        ...
        {
            return Equals(other as SafeComWrapper<VB6IA.Window>);
        }
