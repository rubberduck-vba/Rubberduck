...
{
    public class References : SafeComWrapper<VB6IA.References>, IReferences
    {
        public References(VB6IA.References target) 
            : base(target)
        {
        ...
        private void Target_ItemRemoved(VB6IA.Reference reference)
        {
        ...
        private void Target_ItemAdded(VB6IA.Reference reference)
        {
        ...
        {
            Target.Remove(((ISafeComWrapper<VB6IA.Reference>)reference).Target);
        }

        IEnumerator<IReference> IEnumerable<IReference>.GetEnumerator()
        {
            return new ComWrapperEnumerator<IReference>(Target, o => new Reference((VB6IA.Reference)o));
        }
        ...
        public override bool Equals(ISafeComWrapper<VB6IA.References> other)
        {
        ...
        {
            return Equals(other as SafeComWrapper<VB6IA.References>);
        }
