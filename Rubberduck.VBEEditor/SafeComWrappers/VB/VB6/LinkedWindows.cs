...
{
    public class LinkedWindows : SafeComWrapper<VB6IA.LinkedWindows>, ILinkedWindows
    {
        public LinkedWindows(VB6IA.LinkedWindows linkedWindows)
            : base(linkedWindows)
        {
        }
        ...
        public override bool Equals(ISafeComWrapper<VB6IA.LinkedWindows> other)
        {
        ...
        {
            return Equals(other as SafeComWrapper<VB6IA.LinkedWindows>);
        }
