...
{
    public class Reference : SafeComWrapper<VB6IA.Reference>, IReference
    {
        public Reference(VB6IA.Reference target) 
            : base(target)
        {
        }
        ...
        public override bool Equals(ISafeComWrapper<VB6IA.Reference> other)
        {
        ...
        {
            return Equals(other as SafeComWrapper<VB6IA.Reference>);
        }
