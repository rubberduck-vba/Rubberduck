...
{
    public class CodePane : SafeComWrapper<VB6IA.CodePane>, ICodePane
    {
        public CodePane(VB6IA.CodePane codePane)
            : base(codePane)
        {
        }
        ...
        public override bool Equals(ISafeComWrapper<VB6IA.CodePane> other)
        {
        ...
        {
            return Equals(other as SafeComWrapper<VB6IA.CodePane>);
        }
