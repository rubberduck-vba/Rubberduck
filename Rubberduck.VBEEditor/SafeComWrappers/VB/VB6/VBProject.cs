...
{
    public class VBProject : SafeComWrapper<VB6IA.VBProject>, IVBProject
    {
        public VBProject(VB6IA.VBProject vbProject)
            :base(vbProject)
        {
        }
        ...
        public override bool Equals(ISafeComWrapper<VB6IA.VBProject> other)
        {
        ...
        {
            return Equals(other as SafeComWrapper<VB6IA.VBProject>);
        }
