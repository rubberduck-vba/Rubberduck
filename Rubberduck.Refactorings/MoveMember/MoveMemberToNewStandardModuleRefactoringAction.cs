...
{
    public class MoveMemberToNewStandardModuleRefactoringAction : RefactoringActionWithSuspension<MoveMemberModel>
    {
        ...
        public MoveMemberToNewStandardModuleRefactoringAction(
