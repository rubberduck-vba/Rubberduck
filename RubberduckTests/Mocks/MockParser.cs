...
namespace RubberduckTests.Mocks
{
    public static class MockParser
    {
        public static void ParseString(string inputCode, out QualifiedModuleName qualifiedModuleName, out RubberduckParserState state)
        {
            ...
            qualifiedModuleName = new QualifiedModuleName(new Rubberduck.VBEditor.DisposableWrappers.VBComponent(component));
        ...
        public static RubberduckParser Create(VBE vbe, RubberduckParserState state)
        {
            ...
            attributeParser.Setup(m => m.Parse(It.IsAny<Rubberduck.VBEditor.DisposableWrappers.VBComponent>()))
        ...
        {
            return new RubberduckParser(new Rubberduck.VBEditor.DisposableWrappers.VBE(vbe), state, attributeParser,
