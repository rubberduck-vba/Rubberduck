...
namespace RubberduckTests
{
    ...
    public class ConfigurationTests
    {
        ...
        public void DefaultCodeInspectionsIsAsSpecified()
        {
            ...
            var actual = new CodeInspectionSettings(new HashSet<CodeInspectionSetting> {new CodeInspectionSetting(inspection.Object)}, new WhitelistedNameSetting[] {}).CodeInspections;
