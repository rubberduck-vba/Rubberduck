...
namespace RubberduckTests.Settings
{
    ...
    public class ReferenceSettingsTests
    {
        ...
        {
            return new AddRemoveReferencesUserSettingsViewModel(AddRemoveReferencesSetup.GetReferenceSettingsProvider(settings), new Mock<IFolderBrowserFactory>().Object);
        }
        ...
        public void UpdateConfig_CallsSave()
        {
            ...
            var viewModel = new AddRemoveReferencesUserSettingsViewModel(provider.Object, new Mock<IFolderBrowserFactory>().Object);
