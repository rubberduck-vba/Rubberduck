...
namespace RubberduckTests.Settings
{
    ...
    public class SettingsControlTests
    {
        private Configuration GetDefaultConfig()
        {
            ...
            var userSettings = new UserSettings(generalSettings,null/*hotkey*/,  todoSettings, inspectionSettings, unitTestSettings, null /*indenter*/, null /*window*/);
        ...
        private IEnumerable<IInspection> Inspections()
        {
            return new IInspection[]
            {
                ...
                new EncapsulatePublicFieldInspection(null, null),
