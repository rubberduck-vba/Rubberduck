...
End Sub";
            ...
            var moveDefinition = new TestMoveDefinition(endpoints, ("Log", DeclarationType.Procedure));
        ...
        [Category("Refactorings")]
        [Category("MoveMember")]
        public void UnreferencedSubToNewStdModule(MoveEndpoints endpoints)
        {
...
";
            ...
            var moveDefinition = new TestMoveDefinition(endpoints, (memberToMove, DeclarationType.Procedure), createNewModule: true);
            ...
            var newContent = Support.ParseAndTest(ThisTest, moveDefinition, source);

            StringAssert.Contains("Option Explicit", newContent);
            StringAssert.Contains("Public Sub Foo(", newContent);
        }
...
";
        ...
        [Category("Refactorings")]
        [Category("MoveMember")]
        public void ReferencesNonExclusiveMember(string subLogAccessibility, MoveEndpoints moveType, string expectedStrategyName)
        {
            var memberToMove = "Foo";
            var source = $@"
Option Explicit
...
";
            ...
            var moveDefinition = new TestMoveDefinition(MoveEndpoints.StdToStd, (memberToMove, DeclarationType.Procedure));
...
";
        ...
        [Category("Refactorings")]
        [Category("MoveMember")]
        public void SelfContainedMember(MoveEndpoints moveType, string targetAccessibility)
        {
