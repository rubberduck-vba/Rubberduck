...
";
            ...
            using (state)
            {
                ...
                var fieldDeclaration = state.DeclarationFinder.MatchName(testTargetTuple.target).Single();
                ...
                fieldCandidate.PropertyIdentifier = testTargetTuple.propertyName;
