    ...
    public class CodeExplorerTests
    {
        ...
        public void AddStdModule()
        {
            ...
            using (var state = new RubberduckParserState(vbe.Object, projectRepository, new DeclarationFinderFactory(), vbeEvents.Object))
            {
                ...
                var vm = new CodeExplorerViewModel(new FolderHelper(state), state, _generalSettingsProvider.Object, _windowSettingsProvider.Object, uiDispatcher.Object, removeCommand);
        ...
        public void ExportModule_ExpectExecution()
        {
            ...
            using (var state = new RubberduckParserState(vbe.Object, projectRepository, new DeclarationFinderFactory(), vbeEvents.Object))
            {
                ...
                var uiDispatcher = new Mock<IUiDispatcher>();
                var vm = new CodeExplorerViewModel(new FolderHelper(state), state,
                    _generalSettingsProvider.Object, _windowSettingsProvider.Object, uiDispatcher.Object, removeCommand);
