...
#pragma warning restore 169
        ...
        public void InitializeMocks()
        {
            ...
            _providerFactory.Setup(f => f.CreateProvider(It.IsAny<Rubberduck.VBEditor.DisposableWrappers.VBA.VBProject>()))
                .Returns(_provider.Object);
            _providerFactory.Setup(f => f.CreateProvider(It.IsAny<Rubberduck.VBEditor.DisposableWrappers.VBA.VBProject>(), It.IsAny<IRepository>()))
                .Returns(_provider.Object);
            _providerFactory.Setup(f => f.CreateProvider(It.IsAny<Rubberduck.VBEditor.DisposableWrappers.VBA.VBProject>(), It.IsAny<IRepository>(), It.IsAny<SecureCredentials>()))
                .Returns(_provider.Object);
        ...
        private void SetupVM()
        {
            ...
            var vbe = new Rubberduck.VBEditor.DisposableWrappers.VBA.VBE(_vbe.Object);
        ...
        public void UnsyncedPresenter_AfterLogin_NewPresenterIsCreatedWithCredentials()
        {
            ...
            //assert
            _providerFactory.Verify(f => f.CreateProvider(It.IsAny<Rubberduck.VBEditor.DisposableWrappers.VBA.VBProject>(), It.IsAny<IRepository>(), It.IsAny<SecureCredentials>()));
        }
