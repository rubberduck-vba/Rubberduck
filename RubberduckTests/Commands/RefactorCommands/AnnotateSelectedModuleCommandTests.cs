...
{
    [TestFixture]
    public class AnnotateSelectedModuleCommandTests : RefactorCodePaneCommandTestBase
    {
        [Category("Commands")]
        [Test]
        public void AnnotateDeclaration_CanExecute_InsideMember()
        {
            var vbe = SetupAllowingExecution();
            vbe.ActiveCodePane.Selection = new Selection(4,2);
            ...
            ISelectionService selectionService)
        {
            ...
            return new AnnotateSelectedModuleCommand(refactoring, notifier, selectionService, state, state, selectedDeclarationProvider);
        }
