...
namespace RubberduckTests
{
    public abstract class VbeTestBase
    {
        ...
        protected QualifiedSelection GetQualifiedSelection(Selection selection)
        {
            ...
            return new QualifiedSelection(new QualifiedModuleName(new Rubberduck.VBEditor.DisposableWrappers.VBComponent(_ide.Object.ActiveCodePane.CodeModule.Parent)), selection);
        }
