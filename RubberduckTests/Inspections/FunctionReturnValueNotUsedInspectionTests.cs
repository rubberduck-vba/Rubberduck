...
End Sub";
            ...
            string actual = new Rubberduck.VBEditor.DisposableWrappers.CodeModule(module).Lines();
...
End Function";
            ...
            string actualInterface = new Rubberduck.VBEditor.DisposableWrappers.CodeModule(interfaceModule).Lines();
