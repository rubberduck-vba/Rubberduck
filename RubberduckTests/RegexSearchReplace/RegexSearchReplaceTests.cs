...
namespace RubberduckTests.RegexSearchReplace
{
    ...
    {
        [TestMethod]
        public void RegexSearchReplace_SimpleSearch_ExactMatch()
        {
...
End Sub";
        ...
        [TestMethod]
        public void RegexSearchReplace_SimpleSearch_MatchUSPhoneNumber()
        {
            const string inputCode = @"
Private Sub Foo()
...
End Sub";
            ...
            var regexSearchReplace = new Rubberduck.Navigations.RegexSearchReplace.RegexSearchReplace(new RegexSearchReplaceModel(vbe.Object, parseResult));
            var results = regexSearchReplace.Search("(1-)?\\p{N}{3}-\\p{N}{3}-\\p{N}{4}\\b");
        ...
        [TestMethod]
        public void RegexSearchReplace_SearchReplace_RemoveUSPhoneNumber()
        {
            const string inputCode = @"
Private Sub Foo()
    Dim phoneNumber1 As String
...
End Sub";
            ...
            var regexSearchReplace = new Rubberduck.Navigations.RegexSearchReplace.RegexSearchReplace(new RegexSearchReplaceModel(vbe.Object, parseResult));
            regexSearchReplace.SearchAndReplace("(1-)?\\p{N}{3}-\\p{N}{3}-\\p{N}{4}\\b", "hi");
