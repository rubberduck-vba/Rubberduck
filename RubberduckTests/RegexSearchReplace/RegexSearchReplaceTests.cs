...
//                new Rubberduck.Navigation.RegexSearchReplace.RegexSearchReplace(
//                    new RegexSearchReplaceModel(vbe.Object, parseResult, new QualifiedSelection()));
...
//            var regexSearchReplace =
//                new Rubberduck.Navigation.RegexSearchReplace.RegexSearchReplace(new RegexSearchReplaceModel(
//                    vbe.Object, parseResult,
//                    new QualifiedSelection(new QualifiedModuleName(), new Selection(5, 1, 8, 1))), codePaneFactory);
//            var results = regexSearchReplace.Search("(1-)?\\p{N}{3}-\\p{N}{3}-\\p{N}{4}\\b", RegexSearchReplaceScope.Selection);
...
//                new Rubberduck.Navigation.RegexSearchReplace.RegexSearchReplace(
//                    new RegexSearchReplaceModel(vbe.Object, parseResult, new QualifiedSelection()), codePaneFactory);
//            var results = regexSearchReplace.Search("(1-)?\\p{N}{3}-\\p{N}{3}-\\p{N}{4}\\b", RegexSearchReplaceScope.CurrentProject);
...
//            var results = regexSearchReplace.Search("(1-)?\\p{N}{3}-\\p{N}{3}-\\p{N}{4}\\b", RegexSearchReplaceScope.AllOpenProjects);
